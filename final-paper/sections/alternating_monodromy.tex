...
\textup{(ii)} holds.  The lemma proves the group-theoretic assertion.
The two consequences over $K^{\mathrm{sol}}$ stated in
Theorem~\ref{thm:alternating-monodromy} are proved in
Corollary~\ref{cor:solvable-stability} below.
\end{proof}
