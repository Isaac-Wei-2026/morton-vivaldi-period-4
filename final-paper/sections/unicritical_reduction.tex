...
\cite[Propositions 37, 44, and 48]{Huguin2020Extended}.
...
dynatomic polynomial of $f_c$.  Its critical specialization
$\Phi^*_{d,m}(0,c)$ has degree $\nu_d(m)/d>0$ and is squarefree
\cite[Proposition 47]{Huguin2020Extended}.  Choose a root $c_0$.  Because the
...
is a root of unity.  Such a cycle is parabolic for an iterate, and each
finite parabolic cycle attracts a critical orbit
\cite[Theorem 2.8]{MurakamiSanoTakehira2024}.  The only finite critical
point of $z^d+c$ is $0$, and the attracting basins of two distinct
periodic cycles are disjoint, so two such cycles cannot coexist.  Also
